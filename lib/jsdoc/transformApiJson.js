		...
		oData.symbols.forEach((oSymbol) => {
			...
			if (oSymbol.properties) {
				...
				oSymbol.properties.forEach((oProperty) => {
					...
					// Description
					// Note: The "@since" information is not appended to the description here because it is
					// rendered separately as a dedicated "Since" status in the SubApiDetail view. Appending it
					// would duplicate the version information for typedef/enum properties.
