...
(
	...
	function _titleChanged(oChanges) {
		...
		if (oChanges.mutation === "insert") {
			if (!this.isA("sap.ui.layout.form.FormContainer") || !this.getExpandable()) { // if expander used don't use renderingTitle
	...
	function _expandableChanged(bExpandable) {
		...
		if (bExpandable) { // remove renderingTitle
			_titleChanged.call(this, {object: this, mutation: "remove", child: ""});
		} else if (this.getTitle()) { // use renderingTitle
			_titleChanged.call(this, {object: this, mutation: "insert", child: this.getTitle()});
		}
