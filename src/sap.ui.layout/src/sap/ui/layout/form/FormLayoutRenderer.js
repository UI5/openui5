...
sap.ui.define([
	 ...
	 *
	 * @param {sap.ui.core.RenderManager} rm the RenderManager that can be used for writing to the Render-Output-Buffer
	 * @param {string|sap.ui.core.Title|sap.ui.core.Control} oTitle Title text or <code>Title</code> element
	...
	FormLayoutRenderer.renderTitle = function(rm, oTitle, oExpandButton, bExpander, sLevel, sContentId){
		...
		if (oTitle) {
			...
			const bRenderTitleControl = !bTitleAsString && !oTitle.isA("sap.ui.core.Title");
