...
`;
    ...
    function IllustratedMessageTemplate() {
        return (parametersBundle_css.jsxs("div", { class: "ui5-illustrated-message-root", children: [parametersBundle_css.jsxs("div", { class: "ui5-illustrated-message-inner", children: [parametersBundle_css.jsx("div", { class: "ui5-illustrated-message-illustration", role: this.decorative ? "presentation" : "img", "aria-hidden": this.decorative ? true : undefined, "aria-label": !this.decorative ? this.name : undefined, children: renderIllustration.call(this) }), parametersBundle_css.jsxs("div", { class: "ui5-illustrated-message-text-and-actions-container", children: [this.hasTitle &&
    ...
    function renderIllustration() {
        ...
        if (illustration && typeof illustration === "string") {
            return parametersBundle_css.jsx("div", { dangerouslySetInnerHTML: { __html: illustration } });
        }
        return null;
    }
