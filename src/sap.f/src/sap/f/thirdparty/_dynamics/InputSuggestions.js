sap.ui.define(['exports', 'sap/f/thirdparty/generateHighlightedMarkup', 'sap/f/thirdparty/Search3', 'sap/f/thirdparty/webcomponents-fiori', 'sap/f/thirdparty/ListItemGroup', 'sap/f/thirdparty/ListBoxItemGroupTemplate', 'sap/f/thirdparty/parameters-bundle2.css', 'sap/f/thirdparty/Icon', 'sap/f/thirdparty/List', 'sap/f/thirdparty/ResponsivePopover', 'sap/f/thirdparty/Button2', 'sap/f/thirdparty/Title', 'sap/f/thirdparty/i18n-defaults2', 'sap/f/thirdparty/encodeXML', 'sap/f/thirdparty/event-strict', 'sap/f/thirdparty/ManagedStyles', 'sap/f/thirdparty/ListItemBase', 'sap/f/thirdparty/parameters-bundle.css', 'sap/f/thirdparty/ListItemTemplate', 'sap/f/thirdparty/decline', 'sap/f/thirdparty/Icons', 'sap/f/thirdparty/ValueState', 'sap/f/thirdparty/AccessibilityTextsHelper', 'sap/f/thirdparty/Label', 'sap/f/thirdparty/information', 'sap/f/thirdparty/slim-arrow-down', 'sap/f/thirdparty/search2', 'sap/f/thirdparty/information2', 'sap/f/thirdparty/sys-enter-2', 'sap/f/thirdparty/parameters-bundle3.css', 'sap/f/thirdparty/i18n-defaults', 'sap/f/thirdparty/toLowercaseEnumValue', 'sap/f/thirdparty/WrappingType', 'sap/f/thirdparty/FocusableElements', 'sap/f/thirdparty/willShowContent'], (function (exports, generateHighlightedMarkup, Search, webcomponentsBase, ListItemGroup, ListBoxItemGroupTemplate, parametersBundle_css, Icon, List, ResponsivePopover, Button, Title, i18nDefaults, encodeXML, eventStrict, ManagedStyles, ListItemBase, parametersBundle_css$1, ListItemTemplate, decline, Icons, ValueState, AccessibilityTextsHelper, Label, information, slimArrowDown, search, information$1, sysEnter2, parametersBundle_css$2, i18nDefaults$1, toLowercaseEnumValue, WrappingType, FocusableElements, willShowContent) { 'use strict';
    ...
    function InputSuggestionsTemplate(hooks) {
        ...
        return (parametersBundle_css.jsxs(ResponsivePopover.ResponsivePopover, { class: this.classes.popover, hideArrow: true, preventFocusRestore: true, preventInitialFocus: true, placement: "Bottom", horizontalAlign: "Start", tabindex: -1, style: this.styles.suggestionsPopover, onOpen: this._afterOpenPicker, onClose: this._afterClosePicker, onScroll: this._scroll, open: this.open, opener: this, accessibleName: this._popupLabel, children: [this._isPhone &&
                    parametersBundle_css.jsx(parametersBundle_css.Fragment, { children: parametersBundle_css.jsxs("div", { slot: "header", class: "ui5-responsive-popover-header", children: [parametersBundle_css.jsx("div", { class: "row", children: parametersBundle_css.jsx(Title.Title, { level: "H1", wrappingType: "None", class: "ui5-responsive-popover-header-text", children: this._headerTitleText }) }), parametersBundle_css.jsx("div", { class: "row", children: parametersBundle_css.jsxs("div", { class: "input-root-phone native-input-wrapper", children: [parametersBundle_css.jsx(Search.Input, { class: "ui5-input-inner-phone", type: this.inputType, value: this.value, showClearIcon: this.showClearIcon, placeholder: this.placeholder, onInput: this._handleInput }), mobileHeader?.call(this)] }) }), this.hasValueStateMessage &&
                    ...
                    parametersBundle_css.jsxs("div", { slot: "header", class: {
                        ...
                        }, style: this.styles.suggestionPopoverHeader, children: [parametersBundle_css.jsx(Icon.Icon, { class: "ui5-input-value-state-message-icon", name: valueStateMessageInputIcon?.call(this) }), this.open && valueStateMessage?.call(this)] }), this.showSuggestions && suggestionsList.call(this), this._isPhone &&
                    parametersBundle_css.jsxs("div", { slot: "footer", class: "ui5-responsive-popover-footer", children: [parametersBundle_css.jsx(Button.Button, { design: "Emphasized", onClick: this._confirmMobileValue, children: this._suggestionsOkButtonText }), parametersBundle_css.jsx(Button.Button, { class: "ui5-responsive-popover-close-btn", design: "Transparent", onClick: this._cancelMobileValue, children: this._suggestionsCancelButtonText })] })] }));
    }
