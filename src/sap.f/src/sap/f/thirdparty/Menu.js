...
`;
    ...
    function MenuTemplate() {
        return (parametersBundle_css.jsxs(ResponsivePopover.ResponsivePopover, { id: `${this._id}-menu-rp`, class: "ui5-menu-rp", placement: this.placement, verticalAlign: "Bottom", horizontalAlign: this.horizontalAlign, opener: this.opener, open: this.open, preventInitialFocus: true, hideArrow: true, allowTargetOverlap: true, accessibleName: this.accessibleNameText, onBeforeOpen: this._beforePopoverOpen, onOpen: this._afterPopoverOpen, onBeforeClose: this._beforePopoverClose, onClose: this._afterPopoverClose, children: [this.isPhone &&
                    parametersBundle_css.jsx("div", { slot: "header", class: "ui5-menu-dialog-header", children: parametersBundle_css.jsx("div", { class: "ui5-menu-dialog-title", children: parametersBundle_css.jsx("h1", { children: this.headerText }) }) }), parametersBundle_css.jsx("div", { id: `${this._id}-menu-main`, class: this.loading ? "ui5-menu-busy-indicator-main" : "", children: this.items.length ?
                        ...
                        : this.loading && (parametersBundle_css.jsx(Button.BusyIndicator, { id: `${this._id}-menu-busy-indicator`, delay: this.loadingDelay, class: "ui5-menu-busy-indicator", active: true })) }), this.isPhone &&
                    parametersBundle_css.jsx("div", { slot: "footer", class: "ui5-menu-dialog-footer", children: parametersBundle_css.jsx(Button.Button, { design: "Transparent", onClick: this._close, children: this.labelCancel }) })] }));
    }
