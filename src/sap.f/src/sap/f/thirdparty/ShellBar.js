...
`;
	...
	class ShellBarSearch {
	    ...
	    onSearch(e) {
	        ...
	        if (Icons.d() || (this.getSearchField()?.value && this.getSearchState())) {
	            return;
	        }
	...
	let ShellBar = ShellBar_1 = class ShellBar extends webcomponentsBase.S {
	    ...
	    getCSSVariable(cssVar) {
	        ...
	        return styleSet.getPropertyValue(Icons.f$3(cssVar));
	    }
	};
	__decorate([
	    webcomponentsBase.d()
