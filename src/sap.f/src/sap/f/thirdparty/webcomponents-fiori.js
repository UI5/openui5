sap.ui.define(['require', 'exports', 'sap/f/thirdparty/Icons'], (function (require, exports, Icons) { 'use strict';
     ...
     */
    var t$7;const i$9=globalThis.trustedTypes,s$e=i$9?i$9.createPolicy("lit-html",{createHTML:t=>t}):void 0,e$8=`lit$${(Math.random()+"").slice(9)}$`,o$7="?"+e$8,n$g=`<${o$7}>`,l$8=document,h$1=(t="")=>l$8.createComment(t),r$7=t=>null===t||"object"!=typeof t&&"function"!=typeof t,d$5=Array.isArray,u$7=t=>{var i;return d$5(t)||"function"==typeof(null===(i=t)||void 0===i?void 0:i[Symbol.iterator])},c$6=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,v$2=/-->/g,a$b=/>/g,f$5=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,_$1=/'/g,m$7=/"/g,g$5=/^(?:script|style|textarea|title)$/i,p$3=t=>(i,...s)=>({_$litType$:t,strings:i,values:s}),$=p$3(1),y$4=p$3(2),b$6=Symbol.for("lit-noChange"),w$1=Symbol.for("lit-nothing"),T$1=new WeakMap,A$1=l$8.createTreeWalker(l$8,129,null,false),C$2=(t,i)=>{const o=t.length-1,l=[];let h,r=2===i?"<svg>":"",d=c$6;for(let i=0;i<o;i++){const s=t[i];let o,u,p=-1,$=0;for(;$<s.length&&(d.lastIndex=$,u=d.exec(s),null!==u);)$=d.lastIndex,d===c$6?"!--"===u[1]?d=v$2:void 0!==u[1]?d=a$b:void 0!==u[2]?(g$5.test(u[2])&&(h=RegExp("</"+u[2],"g")),d=f$5):void 0!==u[3]&&(d=f$5):d===f$5?">"===u[0]?(d=null!=h?h:c$6,p=-1):void 0===u[1]?p=-2:(p=d.lastIndex-u[2].length,o=u[1],d=void 0===u[3]?f$5:'"'===u[3]?m$7:_$1):d===m$7||d===_$1?d=f$5:d===v$2||d===a$b?d=c$6:(d=f$5,h=void 0);const y=d===f$5&&t[i+1].startsWith("/>")?" ":"";r+=d===c$6?s+n$g:p>=0?(l.push(o),s.slice(0,p)+"$lit$"+s.slice(p)+e$8+y):s+e$8+(-2===p?(l.push(void 0),i):y);}const u=r+(t[o]||"<?>")+(2===i?"</svg>":"");if(!Array.isArray(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return [void 0!==s$e?s$e.createHTML(u):u,l]};class E{constructor({strings:t,_$litType$:s},n){let l;this.parts=[];let r=0,d=0;const u=t.length-1,c=this.parts,[v,a]=C$2(t,s);if(this.el=E.createElement(v,n),A$1.currentNode=this.el.content,2===s){const t=this.el.content,i=t.firstChild;i.remove(),t.append(...i.childNodes);}for(;null!==(l=A$1.nextNode())&&c.length<u;){if(1===l.nodeType){if(l.hasAttributes()){const t=[];for(const i of l.getAttributeNames())if(i.endsWith("$lit$")||i.startsWith(e$8)){const s=a[d++];if(t.push(i),void 0!==s){const t=l.getAttribute(s.toLowerCase()+"$lit$").split(e$8),i=/([.?@])?(.*)/.exec(s);c.push({type:1,index:r,name:i[2],strings:t,ctor:"."===i[1]?M$2:"?"===i[1]?H:"@"===i[1]?I$1:S$3});}else c.push({type:6,index:r});}for(const i of t)l.removeAttribute(i);}if(g$5.test(l.tagName)){const t=l.textContent.split(e$8),s=t.length-1;if(s>0){l.textContent=i$9?i$9.emptyScript:"";for(let i=0;i<s;i++)l.append(t[i],h$1()),A$1.nextNode(),c.push({type:2,index:++r});l.append(t[s],h$1());}}}else if(8===l.nodeType)if(l.data===o$7)c.push({type:2,index:r});else {let t=-1;for(;-1!==(t=l.data.indexOf(e$8,t+1));)c.push({type:7,index:r}),t+=e$8.length-1;}r++;}}static createElement(t,i){const s=l$8.createElement("template");return s.innerHTML=t,s}}function P$1(t,i,s=t,e){var o,n,l,h;if(i===b$6)return i;let d=void 0!==e?null===(o=s._$Cl)||void 0===o?void 0:o[e]:s._$Cu;const u=r$7(i)?void 0:i._$litDirective$;return (null==d?void 0:d.constructor)!==u&&(null===(n=null==d?void 0:d._$AO)||void 0===n||n.call(d,false),void 0===u?d=void 0:(d=new u(t),d._$AT(t,s,e)),void 0!==e?(null!==(l=(h=s)._$Cl)&&void 0!==l?l:h._$Cl=[])[e]=d:s._$Cu=d),void 0!==d&&(i=P$1(t,d._$AS(t,i.values),d,e)),i}let V$1 = class V{constructor(t,i){this.v=[],this._$AN=void 0,this._$AD=t,this._$AM=i;}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(t){var i;const{el:{content:s},parts:e}=this._$AD,o=(null!==(i=null==t?void 0:t.creationScope)&&void 0!==i?i:l$8).importNode(s,true);A$1.currentNode=o;let n=A$1.nextNode(),h=0,r=0,d=e[0];for(;void 0!==d;){if(h===d.index){let i;2===d.type?i=new N$1(n,n.nextSibling,this,t):1===d.type?i=new d.ctor(n,d.name,d.strings,this,t):6===d.type&&(i=new L$2(n,this,t)),this.v.push(i),d=e[++r];}h!==(null==d?void 0:d.index)&&(n=A$1.nextNode(),h++);}return o}m(t){let i=0;for(const s of this.v) void 0!==s&&(void 0!==s.strings?(s._$AI(t,s,i),i+=s.strings.length-2):s._$AI(t[i])),i++;}};let N$1 = class N{constructor(t,i,s,e){var o;this.type=2,this._$AH=w$1,this._$AN=void 0,this._$AA=t,this._$AB=i,this._$AM=s,this.options=e,this._$Cg=null===(o=null==e?void 0:e.isConnected)||void 0===o||o;}get _$AU(){var t,i;return null!==(i=null===(t=this._$AM)||void 0===t?void 0:t._$AU)&&void 0!==i?i:this._$Cg}get parentNode(){let t=this._$AA.parentNode;const i=this._$AM;return void 0!==i&&11===t.nodeType&&(t=i.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,i=this){t=P$1(this,t,i),r$7(t)?t===w$1||null==t||""===t?(this._$AH!==w$1&&this._$AR(),this._$AH=w$1):t!==this._$AH&&t!==b$6&&this.$(t):void 0!==t._$litType$?this.T(t):void 0!==t.nodeType?this.k(t):u$7(t)?this.S(t):this.$(t);}M(t,i=this._$AB){return this._$AA.parentNode.insertBefore(t,i)}k(t){this._$AH!==t&&(this._$AR(),this._$AH=this.M(t));}$(t){this._$AH!==w$1&&r$7(this._$AH)?this._$AA.nextSibling.data=t:this.k(l$8.createTextNode(t)),this._$AH=t;}T(t){var i;const{values:s,_$litType$:e}=t,o="number"==typeof e?this._$AC(t):(void 0===e.el&&(e.el=E.createElement(e.h,this.options)),e);if((null===(i=this._$AH)||void 0===i?void 0:i._$AD)===o)this._$AH.m(s);else {const t=new V$1(o,this),i=t.p(this.options);t.m(s),this.k(i),this._$AH=t;}}_$AC(t){let i=T$1.get(t.strings);return void 0===i&&T$1.set(t.strings,i=new E(t)),i}S(t){d$5(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let s,e=0;for(const o of t)e===i.length?i.push(s=new N(this.M(h$1()),this.M(h$1()),this,this.options)):s=i[e],s._$AI(o),e++;e<i.length&&(this._$AR(s&&s._$AB.nextSibling,e),i.length=e);}_$AR(t=this._$AA.nextSibling,i){var s;for(null===(s=this._$AP)||void 0===s||s.call(this,false,true,i);t&&t!==this._$AB;){const i=t.nextSibling;t.remove(),t=i;}}setConnected(t){var i;void 0===this._$AM&&(this._$Cg=t,null===(i=this._$AP)||void 0===i||i.call(this,t));}};let S$3 = class S{constructor(t,i,s,e,o){this.type=1,this._$AH=w$1,this._$AN=void 0,this.element=t,this.name=i,this._$AM=e,this.options=o,s.length>2||""!==s[0]||""!==s[1]?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=w$1;}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,i=this,s,e){const o=this.strings;let n=false;if(void 0===o)t=P$1(this,t,i,0),n=!r$7(t)||t!==this._$AH&&t!==b$6,n&&(this._$AH=t);else {const e=t;let l,h;for(t=o[0],l=0;l<o.length-1;l++)h=P$1(this,e[s+l],i,l),h===b$6&&(h=this._$AH[l]),n||(n=!r$7(h)||h!==this._$AH[l]),h===w$1?t=w$1:t!==w$1&&(t+=(null!=h?h:"")+o[l+1]),this._$AH[l]=h;}n&&!e&&this.C(t);}C(t){t===w$1?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=t?t:"");}};let M$2 = class M extends S$3{constructor(){super(...arguments),this.type=3;}C(t){this.element[this.name]=t===w$1?void 0:t;}};const k$1=i$9?i$9.emptyScript:"";class H extends S$3{constructor(){super(...arguments),this.type=4;}C(t){t&&t!==w$1?this.element.setAttribute(this.name,k$1):this.element.removeAttribute(this.name);}}let I$1 = class I extends S$3{constructor(t,i,s,e,o){super(t,i,s,e,o),this.type=5;}_$AI(t,i=this){var s;if((t=null!==(s=P$1(this,t,i,0))&&void 0!==s?s:w$1)===b$6)return;const e=this._$AH,o=t===w$1&&e!==w$1||t.capture!==e.capture||t.once!==e.once||t.passive!==e.passive,n=t!==w$1&&(e===w$1||o);o&&this.element.removeEventListener(this.name,this,e),n&&this.element.addEventListener(this.name,this,t),this._$AH=t;}handleEvent(t){var i,s;"function"==typeof this._$AH?this._$AH.call(null!==(s=null===(i=this.options)||void 0===i?void 0:i.host)&&void 0!==s?s:this.element,t):this._$AH.handleEvent(t);}};let L$2 = class L{constructor(t,i,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=i,this.options=s;}get _$AU(){return this._$AM._$AU}_$AI(t){P$1(this,t);}};const z=window.litHtmlPolyfillSupport;null==z||z(E,N$1),(null!==(t$7=globalThis.litHtmlVersions)&&void 0!==t$7?t$7:globalThis.litHtmlVersions=[]).push("2.2.2");

    /**
     * @license
     * Copyright 2020 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */const o$6=Symbol.for(""),e$7=t=>{var r,e;if((null===(r=t)||void 0===r?void 0:r.r)===o$6)return null===(e=t)||void 0===e?void 0:e._$litStatic$},i$8=t=>({_$litStatic$:t,r:o$6}),a$a=new Map,s$d=t=>(r,...o)=>{const i=o.length;let l,s;const n=[],u=[];let c,v=0,$=false;for(;v<i;){for(c=r[v];v<i&&void 0!==(s=o[v],l=e$7(s));)c+=l+r[++v],$=true;u.push(s),n.push(c),v++;}if(v===i&&n.push(r[i]),$){const t=n.join("$$lit$$");void 0===(r=a$a.get(t))&&(n.raw=n,a$a.set(t,r=n)),o=u;}return t(r,...o)},n$f=s$d($),u$6=s$d(y$4);

    let t$6 = class t{static{this.html=n$f;}static{this.svg=u$6;}static{this.unsafeStatic=i$8;}};Icons.s("LitStatic",t$6);
    ...
    ["sap_fiori_3", "sap_fiori_3_dark", "sap_fiori_3_hcb", "sap_fiori_3_hcw", "sap_horizon", "sap_horizon_auto", "sap_horizon_dark", "sap_horizon_hc_auto", "sap_horizon_hcb", "sap_horizon_hcw"]
        .forEach(themeName => Icons.f("@" + "u" + "i" + "5" + "/" + "w" + "e" + "b" + "c" + "o" + "m" + "p" + "o" + "n" + "e" + "n" + "t" + "s" + "-" + "t" + "h" + "e" + "m" + "i" + "n" + "g", themeName, loadAndCheck$2));
    ...
    ["sap_fiori_3", "sap_fiori_3_dark", "sap_fiori_3_hcb", "sap_fiori_3_hcw", "sap_horizon", "sap_horizon_auto", "sap_horizon_dark", "sap_horizon_hc_auto", "sap_horizon_hcb", "sap_horizon_hcw"]
        .forEach(themeName => Icons.f("@" + "u" + "i" + "5" + "/" + "w" + "e" + "b" + "c" + "o" + "m" + "p" + "o" + "n" + "e" + "n" + "t" + "s", themeName, loadAndCheck$1, "host"));
    ...
    ["sap_fiori_3", "sap_fiori_3_dark", "sap_fiori_3_hcb", "sap_fiori_3_hcw", "sap_horizon", "sap_horizon_auto", "sap_horizon_dark", "sap_horizon_hc_auto", "sap_horizon_hcb", "sap_horizon_hcw"]
        .forEach(themeName => Icons.f("@" + "u" + "i" + "5" + "/" + "w" + "e" + "b" + "c" + "o" + "m" + "p" + "o" + "n" + "e" + "n" + "t" + "s" + "-" + "f" + "i" + "o" + "r" + "i", themeName, loadAndCheck, "host"));
    ...
    let n$d;Icons.i$1(()=>{n$d=void 0;});const d$4=()=>(n$d===void 0&&(n$d=Icons.y$1()),n$d),m$6=o=>{Object.values(Icons.u$1).includes(o)&&(n$d=o);};

    var s$c=(i=>(i.Gregorian="Gregorian",i.Islamic="Islamic",i.Japanese="Japanese",i.Buddhist="Buddhist",i.Persian="Persian",i))(s$c||{});

    let n$c;Icons.i$1(()=>{n$c=void 0;});const i$7=()=>(n$c===void 0&&(n$c=Icons.D$1()),n$c&&n$c in s$c?n$c:s$c.Gregorian);

    let t$4;let a$8 = class a{static getLegacyDateCalendarCustomizing(){return t$4===void 0&&(t$4=Icons.R$1()),t$4.legacyDateCalendarCustomizing||[]}};Icons.s("LegacyDateFormats",a$8);

    let e$6;Icons.i$1(()=>{e$6=void 0;});const n$b=()=>(e$6===void 0&&(e$6=Icons.R$1()),e$6.firstDayOfWeek),i$6=Icons.n$1("LegacyDateFormats"),m$5=i$6?a$8.getLegacyDateCalendarCustomizing:()=>[];
    ...
    const l$7=2;let a$7=null;const g$4=(e,t)=>{a$7=e,t?.dataTransfer?.setData("text/plain",e?e.id:"");},d$3=()=>{a$7=null;},p$2=()=>a$7,u$4=async e=>{const t=document.createElement("div"),n=await Icons.f$2("@ui5/webcomponents-base"),r=t.attachShadow({mode:"open"}),o=new CSSStyleSheet;return o.replaceSync(m$4),r.adoptedStyleSheets=[o],r.textContent=n.getText(e$5,e),t},s$b=async(e,t)=>{if(e<l$7){console.warn(`Cannot start multiple drag with count ${e}. Minimum is ${l$7}.`);return}if(!t.dataTransfer)return;const n=await u$4(e);document.body.appendChild(n),t.dataTransfer.setDragImage(n,0,0),requestAnimationFrame(()=>{n.remove();});},D$2={setDraggedElement:g$4,clearDraggedElement:d$3,getDraggedElement:p$2,startMultipleDrag:s$b};

    const c$5=["value-changed","click"];let e$4;Icons.i$1(()=>{e$4=void 0;});const s$a=t=>c$5.includes(t),l$6=t=>{const n=o$5();return !(typeof n!="boolean"&&n.events&&n.events.includes&&n.events.includes(t))},o$5=()=>(e$4===void 0&&(e$4=Icons.L()),e$4),f$3=t=>{e$4=t;},a$6=t=>{const n=o$5();return s$a(t)?false:n===true?true:!l$6(t)};

    let r$6;const a$5=()=>(r$6===void 0&&(r$6=Icons.I()),r$6),n$a=e=>{r$6=e;};
    ...
    const s$3=o=>{const e=o.constructor,t=o.shadowRoot;if(!t){console.warn("There is no shadow root to update");return}t.adoptedStyleSheets=[Icons.n$2(),...s$4(e)],e.renderer(o,t);};
    ...
    var PackageModule = /*#__PURE__*/Object.freeze({
        ...
        getDefaultTheme: Icons.y$2,
        getEffectiveDir: r$2,
        getEffectiveIconCollection: Icons.i$4,
        getEffectiveScopingSuffixForTag: Icons.d$1,
        getFetchDefaultLanguage: Icons.D$2,
        getFirstDayOfWeek: n$b,
        getI18nBundle: Icons.f$2,
        getIgnoreUrlParams: a$5,
        getLanguage: Icons.L$1,
        ...
        isTablet: Icons.a$2,
        property: s$9,
        registerCustomI18nBundleGetter: Icons.y$3,
        registerI18nLoader: Icons.$,
        registerIconLoader: Icons.C,
        registerLocaleDataLoader: m,
        registerThemePropertiesLoader: Icons.f,
        renderDeferred: Icons.l$2,
        renderFinished: Icons.w,
        renderImmediately: Icons.u$2,
        sanitizeHTML: fnSanitizeHTML,
        scroll: n$e,
        setAnimationMode: m$6,
        setCustomElementsScopingRules: Icons.g$1,
        setCustomElementsScopingSuffix: Icons.p,
        setDefaultIconCollection: Icons.e$2,
        setFetchDefaultLanguage: Icons.p$1,
        setIgnoreUrlParams: n$a,
        setLanguage: Icons.h$2,
        setNoConflict: f$3,
        setTheme: Icons.l$1,
        slideDown: b$5,
        slideUp: u$5,
