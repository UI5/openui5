...
`;
    ...
    let Panel = Panel_1 = class Panel extends webcomponentsBase.S {
        ...
        get shouldNotAnimate() {
            return this.noAnimation || webcomponentsBase.d$1() === Icons.u$1.None;
        }
        _isMobile() {
            if (Icons.l()) {
                this._touched = true;
