...
`;
    ...
    const pathData$9 = "M5.178 2.87c-.237-.228-.237-.466 0-.715A.445.445 0 0 1 5.505 2c.119 0 .228.052.327.155l4.9 5.13c.179.207.268.446.268.715 0 .27-.09.497-.267.684l-4.901 5.16A.46.46 0 0 1 5.49 14a.46.46 0 0 1-.341-.155.503.503 0 0 1 0-.716L9.9 8.155c.119-.103.119-.217 0-.342L5.178 2.87Z";
    const ltr$9 = false;
    ...
    const pathData$8 = "M6.273 3.17a.75.75 0 0 1 1.056.103l3.5 4.247a.75.75 0 0 1 0 .955l-3.5 4.252a.75.75 0 0 1-1.158-.954l3.107-3.775-3.107-3.771a.75.75 0 0 1 .102-1.056Z";
    const ltr$8 = false;
    ...
    let ListItem = ListItem_1 = class ListItem extends ListItemBase.ListItemBase {
        ...
        onBeforeRendering() {
            ...
            this.actionable = (this.type === ListItemType$1.Active || this.type === ListItemType$1.Navigation) && (this._selectionMode !== ListSelectionMode$1.Delete);
        }
        onEnterDOM() {
            super.onEnterDOM();
        ...
        get placeSelectionElementBefore() {
            return this._selectionMode === ListSelectionMode$1.Multiple
                || this._selectionMode === ListSelectionMode$1.SingleStart;
        }
        get placeSelectionElementAfter() {
            return !this.placeSelectionElementBefore
                && (this._selectionMode === ListSelectionMode$1.SingleEnd || this._selectionMode === ListSelectionMode$1.Delete);
        }
        ...
        get modeDelete() {
            return this._selectionMode === ListSelectionMode$1.Delete;
        }
        get typeDetail() {
...
`;
    ...
    let RadioButton = RadioButton_1 = class RadioButton extends webcomponentsBase.S {
        ...
        get ariaLabelText() {
            return AccessibilityTextsHelper.A(this) || undefined;
        }
        get ariaLabelledBy() {
...
`;
    ...
    function CheckBoxTemplate() {
        return (parametersBundle_css.jsxs("div", { class: {
                ...
                "ui5-checkbox--hoverable": !this.disabled && !this.readonly && ManagedStyles.f$1(),
