...
sap.ui.define([
	...
	function (library,
		 ...
		 *
		 * <b>Note:</b> <code>sap.m.NotificationListBase</code> and its subclasses will no longer be aligned with future design updates. Use the UI5 Web Components' notifications instead,
