...
], function(Localization, IllustratedMessageType, MLibrary, Library, Locale, LocaleData, syncStyleClass, Theming, ThemeParameters, IllustratedMessage, Button, CustomListItem, ResponsivePopover, InvisibleMessage) {
	"use strict";
	/*global Intl*/
