...
sap.ui.define([
	 ...
	 * @param {function((sap.m.MessageBox.Action | string)):void} [mOptions.onClose] Function to be called when the user taps a button or closes the message box.
	 ...
	 * @param {string} vMessage Message to be displayed in the alert dialog. The usage of sap.core.Control as vMessage is deprecated since version 1.30.4.
	 * @param {object} [mOptions] Other options (optional)
	 * @param {function((sap.m.MessageBox.Action | string)):void} [mOptions.onClose] callback function to be called when the user closes the dialog
	 ...
	 * @param {string} vMessage Message to be displayed in the alert dialog. The usage of sap.core.Control as vMessage is deprecated since version 1.30.4.
	 * @param {object} [mOptions] Other options (optional)
	 * @param {function((sap.m.MessageBox.Action | string)):void} [mOptions.onClose] Callback to be called when the user closes the dialog
	 ...
	 * @param {string} vMessage Message to be displayed in the alert dialog. The usage of sap.core.Control as vMessage is deprecated since version 1.30.4.
	 * @param {object} [mOptions] Other options (optional)
	 * @param {function((sap.m.MessageBox.Action | string)):void} [mOptions.onClose] Callback when the user closes the dialog
