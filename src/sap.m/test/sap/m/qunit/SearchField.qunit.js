...
sap.ui.define([
	...
	QUnit.test("ariaControls association sets aria-controls attribute", async function(assert) {
		// arrange
	...
	QUnit.test("removeAriaControl removes aria-controls attribute", async function(assert) {
		// arrange
