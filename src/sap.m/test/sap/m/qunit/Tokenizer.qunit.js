...
sap.ui.define([
	...
	"sap/m/Panel",
	"sap/m/Button"
], function(nextUIUpdate, Element, Library1, InvisibleMessage, qutils, createAndAppendDiv, Tokenizer, Token, Dialog, Label, MultiInput, Event, Device, KeyCodes, Library, JSONModel, jQuery, Panel, Button) {
	"use strict";
