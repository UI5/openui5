...
sap.ui.define([
	...
	QUnit.test("MarkersOrder", function(assert) {
		...
		assert.equal(markers.eq(0).control(0).getSrc(), "sap-icon://favorite", "Favorite marker should be rendered first");
		assert.equal(markers.eq(1).control(0).getSrc(), "sap-icon://flag", "Flag marker should be rendered second");
	});
