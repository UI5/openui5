...
sap.ui.define([
	...
	QUnit.test("Expandable panel with headerText and header toolbar", function(assert) {
		...
		assert.notStrictEqual(this.oPanel.oButtonCollapsed.$().attr("aria-labelledby"), sHeaderToolbarTitleId, "should have collapse button with no labelledby reference to the toolbar title");
	});
	...
	QUnit.test("Expandable panel with headerText and reinitialized header toolbar", function(assert) {
		...
		assert.notStrictEqual(this.oPanel.oButtonCollapsed.$().attr("aria-labelledby"), sNewHeaderToolbarTitleId, "should have collapse button with no labelledby reference to the toolbar title");
	});
