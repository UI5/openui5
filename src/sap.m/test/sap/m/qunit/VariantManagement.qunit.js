...
//			assert.equal(this.oVM.getDefaultKey(), "2", "expected default");
	...
	QUnit.test("VariantManagement check aria-expanded initial state", function(assert) {
		this.oVM.addItem(new VariantItem({key: "1", title:"One"}));
	...
	QUnit.test("VariantManagement check aria-expanded attribute", function(assert) {
		this.oVM.addItem(new VariantItem({key: "1", title:"One"}));
		this.oVM.addItem(new VariantItem({key: "2", title:"Two"}));
		this.oVM.setSelectedKey("1");
	...
	QUnit.test("VariantManagement check aria-expanded attribute in error state", function(assert) {
		this.oVM.addItem(new VariantItem({key: "1", title:"One"}));
		this.oVM.setSelectedKey("1");
