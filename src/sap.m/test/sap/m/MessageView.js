...
], function(Log, JSONModel, MessageItem, MessageView, Button, IconPool, Dialog, Page, mobileLibrary, MessagePopover, Popover, Bar, Text, OverflowToolbarLayoutData, Toolbar, ToolbarSpacer, CheckBox, OverflowToolbar, SplitApp, jQuery) {
	"use strict";
