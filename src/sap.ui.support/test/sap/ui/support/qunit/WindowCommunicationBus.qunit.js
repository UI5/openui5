...
sap.ui.define([
	...
	QUnit.test('Populated frame with matching details should pass', function (assert) {
		// arrange
		var sOrigin = "http://example.com";
		var sIdentifier = "12345";
		var sUrl = sOrigin + "/support-tool.html?param=value";
	...
	QUnit.test('Should accept _origin with matching pathname for relative frame URL', function (assert) {
		...
		var sOrigin = "http://example.com";
		var sIdentifier = "12345";
		var sRelativeUrl = "../support/tool.html?sap-ui-xx-support-origin=" + encodeURIComponent(sOrigin);
