...
sap.ui.define([
	...
	const JSONListFilterDelegate = Object.assign({}, FilterBarDelegate);

	const _createFilterField = async (sId, oProperty) => {
	...
	JSONListFilterDelegate._createFilter = async function(sPropertyKey, oFilterBar, mPropertyBag) {
	...
	JSONListFilterDelegate.addItem = function(oFilterBar, sPropertyKey, mPropertyBag) {
		return Promise.resolve(this._createFilter(sPropertyKey, oFilterBar, mPropertyBag));
	};

	return JSONListFilterDelegate;
}, /* bExport= */false);
