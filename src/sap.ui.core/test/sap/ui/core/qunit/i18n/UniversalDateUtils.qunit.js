...
[
	...
	QUnit.test("Static Methods Test getRange", function (assert) {
		...
		Configuration.getFormatSettings().setFirstDayOfWeek(1); // monday is first day of week
		...
		delete Configuration.getFormatSettings().getCustomLocaleData()["weekData-firstDay"]; // reset first day of week
	});
