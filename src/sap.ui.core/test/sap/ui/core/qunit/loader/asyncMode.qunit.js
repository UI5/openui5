...
(function() {
	...
	QUnit.test("sap.ui.require rejects single-encoded dot segments (%2E)", function(assert) {
	...
	QUnit.test("sap.ui.require rejects double-encoded dot segments (%252E)", function(assert) {
		var deferred = new Deferred();
		sap.ui.require(
